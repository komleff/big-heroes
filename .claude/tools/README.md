...
Требования:
- Node.js ≥ 18 (для `parseArgs` из `node:util`).
...
|---|---|---|
| 0 | OK | — |
| 1 | Ошибка API / сети | См. раздел «Ошибки API» ниже |
...
Скрипт классифицирует ошибку по HTTP-статусу и печатает actionable-сообщение на stderr.

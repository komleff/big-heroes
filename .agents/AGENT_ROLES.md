...
| **Sprint Final** | Конец спринта, перед merge | Внешние модели через `/external-review` (оба ревьюера по всем 4 аспектам). В API key режиме: GPT-5.4 + GPT-5.3-Codex. В ChatGPT режиме: один проход дефолтной модели. |

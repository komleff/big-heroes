...
- Новый предмет лучше (tier выше, или tier== и бонусы выше) → экипировать, **старый предмет в рюкзак**

Старый предмет **не удаляется**, а помещается в `expedition.itemsFound`. Решение оператора 2026-04-10.
